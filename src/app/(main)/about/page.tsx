      ...
      <div className='mb-12 md:mb-16'>
        ...
        <div className='grid lg:grid-cols-2 mb-8 gap-4 lg:gap-8'>
          <div className='relative min-h-[300px] '>
            <Image placeholder="blur" className="rounded-xl" src="/images/full.jpg" fill style={{objectFit: 'cover'}} alt="Product" />
          </div>
        ...
        <div className='grid md:grid-cols-2 gap-4 md:gap-8'>
          ...
          <div className='relative rounded-xl w-full min-h-[250px]'>
            <Image placeholder="blur" className='rounded-xl' fill style={{objectFit: 'cover'}} src="/images/service.jpeg" alt="Founder"/>
          </div>
        </div>
      </div>
